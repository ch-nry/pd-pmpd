...
PMPD_EXPORT void pmpd_setup(void)
{
...
*/
    ...
    class_addmethod(pmpd_class, (t_method)pmpd_massesPosL,      			gensym("massPosL"), A_GIMME, 0);
    class_addmethod(pmpd_class, (t_method)pmpd_massesSpeedsL,   			gensym("massSpeedL"), A_GIMME, 0);
    class_addmethod(pmpd_class, (t_method)pmpd_massesForcesL,   			gensym("massForceL"), A_GIMME, 0);
    ...
    class_addmethod(pmpd_class, (t_method)pmpd_linksPosL,           		gensym("linkPosL"), A_GIMME, 0);
    class_addmethod(pmpd_class, (t_method)pmpd_linksLengthL,            gensym("linkLengthL"), A_GIMME, 0);
    class_addmethod(pmpd_class, (t_method)pmpd_linksPosSpeedL,          gensym("linkPosSpeedL"), A_GIMME, 0);
    class_addmethod(pmpd_class, (t_method)pmpd_linksLengthSpeedL,       gensym("linkLengthSpeedL"), A_GIMME, 0);
